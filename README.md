...
- 3.6GHz Fx8150 single thread + 1333MHz DDR3 RAM (simd=32): 89 cycles per pixel (~30 ms per 1000x1000 image).

- Godbolt.org AVX512 server single thread (simd=64): 12 cycles per pixel (-std=c++2a -O3 -march=cascadelake -mavx512f -mavx512bw -mprefer-vector-width=512  -ftree-vectorize -fno-math-errno) (less than 5 ms per 1000x1000 image)
