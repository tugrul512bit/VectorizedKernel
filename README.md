...
- Godbolt.org AVX512 server single thread (simd=32): 12 cycles per pixel (-std=c++2a -O3 -march=cascadelake -mavx512f -mavx512bw -mprefer-vector-width=512  -ftree-vectorize -fno-math-errno) (less than 5 ms per 1000x1000 image)
